...
public class BaseActor extends Group
{
    ...
    public BaseActor()
    {
        ...
        // everyone has a default shape now.
    ...
    public void moveToCenter(BaseActor target)
    {
        this.setPosition( 
            target.getX() + target.getWidth()/2 - this.getWidth()/2, 
            target.getY() + target.getHeight()/2 - this.getHeight()/2 );
    }
